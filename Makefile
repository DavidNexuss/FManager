#############################################################################
# Makefile for building: FManager
# Generated by qmake (3.1) (Qt 5.15.2)
# Project:  FManager.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile FManager.pro
#############################################################################
...
CXXFLAGS      = -pipe -fopenmp -O2 -std=gnu++11 -Wall -Wextra -D_REENTRANT -fPIC $(DEFINES)
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = FManager1.0.0
DISTDIR = /home/david/Projects/FManager/.tmp/FManager1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS) -lmediainfo -ldl -fopenmp /usr/lib/libQt5Widgets.so /usr/lib/libQt5Gui.so /usr/lib/libQt5Core.so -lGL -lpthread   
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
SOURCES       = filetable.cpp \
		main.cpp \
		mainwindow.cpp qrc_qmake_qmake_immediate.cpp \
		moc_filetable.cpp \
		moc_mainwindow.cpp
OBJECTS       = filetable.o \
		main.o \
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		FManager.pro filetable.h \
		mainwindow.h filetable.cpp \
		main.cpp \
		mainwindow.cpp
QMAKE_TARGET  = FManager
DESTDIR       = 
TARGET        = FManager
...
FManager: ui_mainwindow.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: FManager.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents filetable.h mainwindow.h $(DISTDIR)/
	$(COPY_FILE) --parents filetable.cpp main.cpp mainwindow.cpp $(DISTDIR)/
...
moc_predefs.h: /usr/lib/qt/mkspecs/features/data/dummy.cpp
	g++ -pipe -fopenmp -O2 -std=gnu++11 -Wall -Wextra -dM -E -o moc_predefs.h /usr/lib/qt/mkspecs/features/data/dummy.cpp

compiler_moc_header_make_all: moc_filetable.cpp moc_mainwindow.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_filetable.cpp moc_mainwindow.cpp
moc_filetable.cpp: filetable.h \
		moc_predefs.h \
		/usr/bin/moc
	/usr/bin/moc $(DEFINES) --include /home/david/Projects/FManager/moc_predefs.h -I/usr/lib/qt/mkspecs/linux-g++ -I/home/david/Projects/FManager -I/usr/include/qt -I/usr/include/qt/QtWidgets -I/usr/include/qt/QtGui -I/usr/include/qt/QtCore -I/usr/include/c++/10.2.0 -I/usr/include/c++/10.2.0/x86_64-pc-linux-gnu -I/usr/include/c++/10.2.0/backward -I/usr/lib/gcc/x86_64-pc-linux-gnu/10.2.0/include -I/usr/local/include -I/usr/lib/gcc/x86_64-pc-linux-gnu/10.2.0/include-fixed -I/usr/include filetable.h -o moc_filetable.cpp
...
filetable.o: filetable.cpp filetable.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o filetable.o filetable.cpp
...
moc_filetable.o: moc_filetable.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_filetable.o moc_filetable.cpp
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/FManager/bin || mkdir -p $(INSTALL_ROOT)/opt/FManager/bin
	$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/FManager/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/FManager/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/FManager/bin/ 
